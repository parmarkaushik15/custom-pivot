...
export class PeriodService {
  ...
  getPeriodArray(type, year) {
    ...
    if (type === 'Weekly') {
      ...
      periods.push({id: year + '12', name: 'December ' + year}, {id: year + '11', name: 'November ' + year}, {id: year + '10', name: 'October ' + year}, {id: year + '09', name: 'September ' + year}, {id: year + '08', name: 'August ' + year}, {id: year + '07', name: 'July ' + year}, {id: year + '06', name: 'June ' + year}, {id: year + '05', name: 'May ' + year}, {id: year + '04', name: 'April ' + year}, {
        id: year + '03',
        name: 'March ' + year
      }, {id: year + '02', name: 'February ' + year}, {id: year + '01', name: 'January ' + year, selected: true})
  ...
  isDateInPeriod(date, period) {
    ...
    if (period === 'LAST_12_MONTHS') {
      ...
      periodStartDate = new Date(parseInt(period.substr(0, 4), 10), (parseInt(period.substr(5), 10) - 1) * 3);
      periodEndDate = new Date(parseInt(period.substr(0, 4), 10), ((parseInt(period.substr(5), 10) - 1) * 3) + 3, 0)
    } else if (period.indexOf('July') > -1) {
      periodStartDate = new Date(parseInt(period.substr(0, 4), 10), 6);
      periodEndDate = new Date(parseInt(period.substr(0, 4), 10) + 1, 6, 0)
    } else {
      periodStartDate = new Date(parseInt(period.substr(0, 4), 10), parseInt(period.substr(4), 10) - 1);
      periodEndDate = new Date(parseInt(period.substr(0, 4), 10), parseInt(period.substr(4), 10), 0)
    }
