...
export class VisualizerService {
  ...
  drawPieChart(analyticsObject, chartConfiguration) {
    ...
    const metaDataObject = this.prepareCategories(analyticsObject, chartConfiguration.xAxisType, chartConfiguration.yAxisType, chartConfiguration.xAxisItems, chartConfiguration.yAxisItems);
    const serie = [];
